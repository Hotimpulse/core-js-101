...
function getPolynom(...args) {
  ...
  return function getPolyFromCoefficients(x) {
    return args.reduce(
      (res, coefficient, index) => res + coefficient * (x ** (args.length - 1 - index)),
      0,
    );
  };
}
...
function partialUsingArguments(fn, ...args1) {
  return function moreArgs(...args2) {
